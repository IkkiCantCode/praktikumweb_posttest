...
<html>
    ...
    <body class="light-mode" onload="startTime()">
        ...
        <section class="section-dash">
            <button class="link-button"><a href="logout.php" onClick="1">Back</a></button>
        ...
        <section class="lampents">
            <div class="center-content-lampent">
                ...
                <div class="text-box">
                    <h2>Hai Admin, Lampent Here</h2>
                    <p>Right Now You're On The Dahsboard Menu!</p>
                    <p>Time Right Now Is</p>
                    <p id="txt"><?php date_default_timezone_set("Asia/Makassar");
                     ?></p>
                    <p><?php echo "Today Is " . date("l, d-M-Y"); ?></p>
                    <p>Also, Click "Back" to End Session</p>
                </div>
            </div>
