...
const froslassImage = document.getElementById("froslass-image");
const froslassAudio = document.getElementById("froslass-cry");
if (froslassImage) {
    froslassImage.addEventListener("click", function() {
        if (!froslassAudio.paused) {
            froslassAudio.pause();
        }
        froslassAudio.currentTime = 0;
        froslassAudio.play();
    });
}
